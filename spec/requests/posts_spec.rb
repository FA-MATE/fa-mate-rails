...
RSpec.describe "/posts", type: :request do
  let!(:old_post) { FactoryBot.create :post_completed }
  let(:valid_attributes) do
    {
      ...
      post_images_attributes: [ { image: old_post.post_images.first.image, order_no: old_post.post_images.first.order_no } ],
    }
  end
